...
## Phase 34 — Per-workspace calendars (in-app connect, multi-account) _(34-A–34-D Done; 34-E ICS feed in progress)_
...
## Phase 35 — Claude Cowork connector (read-only MCP server) _(In Progress — 35-A + OAuth (35-E) done; 35-B/C/D remain)_
