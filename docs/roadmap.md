...
## Phase 33 — Higher-quality speaker-labelled transcripts via Amazon Transcribe batch _(In Progress — 33-A, 33-B1 done; 33-B2 remaining)_
...
## Phase 34 — Per-workspace calendars (in-app connect, multi-account) _(In Progress — 34-A, 34-B, 34-C done)_
...
## Phase 35 — Claude Cowork connector (read-only MCP server) _(In Progress — 35-A done)_
