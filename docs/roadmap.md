...
## Phase 31 — Desktop app (no per-meeting audio-share consent) _(Done — Windows shell, pinned loopback grant, unsigned installer; final `.exe` verify is a manual Windows step)_
