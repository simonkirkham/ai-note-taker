...
**Fixed 2026-09-21. PR #489, deploy #785 (deploy-production ran); desktop installer published and verified to name `695ee14`.** Four changes, all in the desktop shell:
