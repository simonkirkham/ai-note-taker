...
| A failed automatic write-up could never be retried and its error message vanished on the next tab switch, leaving the note un-analysed with nothing saying the manual button needed pressing. The one-shot claim is handed back on failure. | — |
