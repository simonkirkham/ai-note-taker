...
39-B (the to-do mirror) was a clean, low-risk slice, but it sat un-mergeable for hours because a **parallel session's** `TodoReorderJourney` (37-A) deterministically red-gated `main` ([BUG-39](../phases/phase-bugs.md#bug-39)). Two durable lessons:
