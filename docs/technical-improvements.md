...
| TI-19 | Stabilise the flaky `TagsJourney` E2E                                          | ✅ **Re-resolved** — [BUG-22](phases/phase-bugs.md#bug-22--multi-tag-add-drops-a-pill-under-ryw-2-async-reads--consistency-token-slot-overwritten-by-an-older-version) (deploy #551, E2E 20/20 first-try); one test-robustness follow-up open |
