...
public sealed class ProjectorTests
{
    ...
    private sealed class ThrowingUpdater : IProjectionUpdater
    {
        ...
        public Task ApplyTodoOrderEventsAsync(IReadOnlyList<IDomainEvent> newEvents, List<EventEnvelope> newEnvelopes, CancellationToken ct) => throw new InvalidOperationException("boom");
