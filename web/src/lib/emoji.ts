...
// inside code — a fenced block or an inline code span keeps `:tada:` literal. Splitting
// on the code delimiters (captured, so they land at odd indices) lets us transform only
// the prose segments.
