  ...
  return (
    <div className="sign-in-page">
      <div className="sign-in-card">
        <span className="sign-in-badge" aria-hidden="true">AI</span>
        <h1 className="sign-in-title">AI Note Taker</h1>
        <p className="sign-in-tagline">Capture meetings, surface what matters.</p>
        <button type="button" className="sign-in-button" onClick={signIn}>
          <GoogleMark />
          Sign in with Google
        </button>
      </div>
