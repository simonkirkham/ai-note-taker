...
{
    Task RecordSuggestionAsync(string userId, string noteId, string tag, string promptVersion, CancellationToken ct = default);
    ...
    Task PutProvenanceAsync(string noteId, string tag, string userId, string promptVersion, CancellationToken ct = default);
